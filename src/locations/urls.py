...
urlpatterns = [
    ...
    # celery task views
    path("load-data/", load_locations_view, name='locations_load_data'),
    path("cities/load-data/", load_cities_view, name='locations_load_data_cities'),
    path("regions/load-data/", load_regions_view, name='locations_load_data_regions'),
